      ...
      <main className="relative bg-altrix-dark pt-32 pb-20 min-h-screen flex flex-col justify-between">
        <div className="max-w-4xl mx-auto px-6 z-10 w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-20">
            <a
              href="https://wa.me/919571425884?text=Hi%20Webio%2C%20I%20am%20interested%20in%20your%20No%20Upfront%20Cost%20Website%20for%20Indian%20Businesses%20package."
              target="_blank"
